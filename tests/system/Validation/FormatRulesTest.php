...
class FormatRulesTest extends CIUnitTestCase
{
    ...
    public function testIntegerWithInvalidTypeData(mixed $value, bool $expected): void
    {
        $this->validation->setRules([
            'foo' => 'integer',
        ]);
     ...
     */
    #[DataProvider('provideInvalidIntegerType')]
    public function testNumericWithInvalidTypeData(mixed $value, bool $expected): void
    {
        $this->validation->setRules([
            'foo' => 'numeric',
        ]);
